...
function EncounterDetail({
  ...
  const chartRows = runs.map((run) => ({
    ...
    resultClass: getResultClass(run.success),
    ...
    <div className={cx(panelClass, "grid gap-[0.85rem]")}>
      ...
      <div className="grid gap-[0.45rem]">
        ...
        <div className="overflow-x-auto rounded-xl border border-line bg-base-100 p-[0.65rem]">
          <div className="h-[18rem] min-w-full" style={{ width: `${chartWidth}px` }}>
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <YAxis
                  width={58}
                  tickMargin={8}
                  tickFormatter={formatEncounterDurationTick}
...
function EncounterDurationTooltip({
  ...
  return (
    <div className="grid min-w-[12rem] gap-[0.35rem] rounded-xl border border-line bg-panel px-3 py-2 shadow-lg">
...
function formatEncounterDurationTick(seconds: number): string {
